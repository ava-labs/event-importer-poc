...
var MockPriceFeedAggregatorMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"int256\",\"name\":\"current\",\"type\":\"int256\"},{\"indexed\":true,\"internalType\":\"uint256\",\"name\":\"roundId\",\"type\":\"uint256\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"updatedAt\",\"type\":\"uint256\"}],\"name\":\"AnswerUpdated\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"currentAnswer\",\"outputs\":[{\"internalType\":\"int256\",\"name\":\"\",\"type\":\"int256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"latestRoundData\",\"outputs\":[{\"internalType\":\"uint80\",\"name\":\"\",\"type\":\"uint80\"},{\"internalType\":\"int256\",\"name\":\"\",\"type\":\"int256\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"uint80\",\"name\":\"\",\"type\":\"uint80\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"roundID\",\"outputs\":[{\"internalType\":\"uint80\",\"name\":\"\",\"type\":\"uint80\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"int256\",\"name\":\"_currentAnswer\",\"type\":\"int256\"},{\"internalType\":\"uint80\",\"name\":\"_roundID\",\"type\":\"uint80\"},{\"internalType\":\"uint256\",\"name\":\"_updatedAt\",\"type\":\"uint256\"}],\"name\":\"updateAnswer\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"updatedAt\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Bin: "",
}
...
//
// Solidity: function updateAnswer(int256 _currentAnswer, uint80 _roundID, uint256 _updatedAt) returns()
func (_MockPriceFeedAggregator *MockPriceFeedAggregatorTransactor) UpdateAnswer(opts *bind.TransactOpts, _currentAnswer *big.Int, _roundID *big.Int, _updatedAt *big.Int) (*types.Transaction, error) {
	return _MockPriceFeedAggregator.contract.Transact(opts, "updateAnswer", _currentAnswer, _roundID, _updatedAt)
}

// UpdateAnswer is a paid mutator transaction binding the contract method 0x683d010d.
//
// Solidity: function updateAnswer(int256 _currentAnswer, uint80 _roundID, uint256 _updatedAt) returns()
func (_MockPriceFeedAggregator *MockPriceFeedAggregatorSession) UpdateAnswer(_currentAnswer *big.Int, _roundID *big.Int, _updatedAt *big.Int) (*types.Transaction, error) {
	return _MockPriceFeedAggregator.Contract.UpdateAnswer(&_MockPriceFeedAggregator.TransactOpts, _currentAnswer, _roundID, _updatedAt)
}

// UpdateAnswer is a paid mutator transaction binding the contract method 0x683d010d.
//
// Solidity: function updateAnswer(int256 _currentAnswer, uint80 _roundID, uint256 _updatedAt) returns()
func (_MockPriceFeedAggregator *MockPriceFeedAggregatorTransactorSession) UpdateAnswer(_currentAnswer *big.Int, _roundID *big.Int, _updatedAt *big.Int) (*types.Transaction, error) {
	return _MockPriceFeedAggregator.Contract.UpdateAnswer(&_MockPriceFeedAggregator.TransactOpts, _currentAnswer, _roundID, _updatedAt)
}
