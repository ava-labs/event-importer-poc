...
func ConstructCorethReceiptProof(
	...
	receiptTrie, err := corethtrie.New(corethtrie.StateTrieID(common.Hash{}), corethtrie.NewDatabase(nil))
	if err != nil {
...
func ConstructSubnetEVMReceiptProof(
	...
	// Create a trie of the receipts
	receiptTrie, err := subnetevmtrie.New(subnetevmtrie.StateTrieID(common.Hash{}), subnetevmtrie.NewDatabase(nil))
	if err != nil {
		log.Error("Failed to create receipt trie", "err", err)
		return nil, err
	}
